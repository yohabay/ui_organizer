...
export const designerTemplates: Template[] = [
  // FLOATING & OVERLAPPING DESIGNS
  {
    ...
    description:
      "Hero image with floating card overlays creating depth and visual interest",
    ...
    slots: [
      ...
      { x: 6, y: 2, w: 4, h: 3, rotation: -5, zIndex: 3, shadow: "xl" }, // Floating card 1
      { x: 1, y: 5, w: 3, h: 4, rotation: 8, zIndex: 2, shadow: "lg" }, // Floating card 2
      { x: 8, y: 7, w: 3, h: 3, rotation: -3, zIndex: 2, shadow: "lg" }, // Floating card 3
...

  {
    ...
    description:
      "Screenshots arranged in a dynamic diagonal flow with varying sizes",
...

  {
    ...
    description:
      "Central hero with screenshots arranged in a circular pattern around it",
...

  {
    ...
    description:
      "Bold asymmetric layout with overlapping elements and varied proportions",
    ...
    slots: [
      ...
      { x: 5, y: 1, w: 4, h: 3, rotation: 3, zIndex: 2, shadow: "xl" }, // Overlapping element
...

  {
    ...
    description:
      "Pinterest-style staggered layout with varying heights and subtle rotations",
  ...
  // CREATIVE MOBILE DESIGNS
  {
    ...
    name: "3D Phone Stack",
    description:
      "Mobile screenshots in a 3D stacked phone mockup with perspective",
...

  {
    ...
    description:
      "Connected mobile screens showing user flow with arrows and connections",
...

  {
    ...
    description:
      "Central dashboard with supporting UI elements in a spotlight arrangement",
  ...
  // CREATIVE ARTISTIC DESIGNS
  {
    ...
    description:
      "Scattered polaroid-style photos with handwritten labels and tape effects",
...

  {
    ...
    description:
      "Editorial magazine layout with text blocks and image arrangements",
...

  {
    ...
    description:
      "Hexagonal arrangement with geometric patterns and modern aesthetics",
  ...
  // INNOVATIVE LAYOUTS
  {
    ...
    name: "Spiral Galaxy",
    description:
      "Screenshots arranged in a spiral pattern creating dynamic visual flow",
...

  {
    ...
    name: "Infinity Loop",
    description:
      "Figure-8 arrangement creating an infinity symbol with flowing screenshots",
  ...
  // MODERN PORTFOLIO STYLES
  {
    ...
    description:
      "Modern portfolio grid inspired by Dribbble with hover effects",
...

  {
    ...
    name: "Behance Hero",
    description:
      "Behance-style hero layout with project details and supporting images",
  ...
  // EXPERIMENTAL DESIGNS
  {
    ...
    name: "Liquid Flow",
    description:
      "Organic, flowing layout with curved edges and liquid-like arrangement",
...

  {
    ...
    name: "Neon Grid",
    description:
      "Cyberpunk-inspired layout with neon glows and futuristic aesthetics",
  ...
  // MINIMALIST MODERN
  {
    ...
    name: "Swiss Minimal",
    description:
      "Clean Swiss design principles with perfect typography and spacing",
    ...
    slots: [
      ...
      { x: 0, y: 9, w: 6, h: 3, borderRadius: "none" },
      { x: 6, y: 9, w: 6, h: 3, borderRadius: "none" },
    ],
...

  {
    ...
    description:
      "Bold brutalist design with stark contrasts and geometric blocks",
  ...
  // INTERACTIVE & DYNAMIC
  {
    ...
    description:
      "Multi-layered design with parallax scrolling effects and depth",
...

  {
    ...
    description:
      "Dynamic shapes that morph and transform with organic animations",
  ...
  // Add 30 more templates to reach 50+...
  {
    ...
    description:
      "Nostalgic collage with torn edges, vintage filters, and scrapbook aesthetics",
...

  {
    ...
    description:
      "Futuristic holographic interface with transparent overlays and sci-fi aesthetics",
  ...
  // Continue with more creative templates...
  {
    ...
    name: "Origami Fold",
    description:
      "Paper-folding inspired layout with geometric folds and shadow play",
...

  {
    ...
    description:
      "Star constellation pattern with connected screenshots forming celestial designs",
...

  {
    ...
    description:
      "Symmetrical kaleidoscope arrangement with mirrored and rotated elements",
...

  {
    ...
    description:
      "Comic book style panels with speech bubbles and dynamic action layouts",
...

  {
    ...
    description:
      "Technical blueprint style with precise measurements and architectural elements",
...

  {
    ...
    description:
      "Artistic watercolor effects with organic splashes and paint-like textures",
    category: "Artistic Layouts",
    projectTypes: ["mobile", "website"],
    rows: 10,
    cols: 10,
...

  {
    ...
    name: "Isometric Cube",
    description:
      "3D isometric cube arrangement with perspective and depth illusion",
    category: "3D Layouts",
    projectTypes: ["desktop", "website"],
    rows: 12,
    cols: 12,
...

  {
    ...
    description:
      "Vintage vinyl record layout with rotating discs and music-inspired aesthetics",
